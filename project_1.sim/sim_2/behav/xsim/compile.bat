...
REM
REM Generated by Vivado on Tue Jun 09 10:11:54 +0530 2026
...
echo "xvlog --incr --relax -prj ALU2_tb_vlog.prj"
call xvlog  --incr --relax -prj ALU2_tb_vlog.prj -log xvlog.log
